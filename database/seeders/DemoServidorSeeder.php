...
class DemoServidorSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::connection('personas_fast')->table('personas')->updateOrInsert(['rut_normalizado'=>'102115686'], ['rut_original'=>'10.211.568-6','rut_cuerpo'=>10211568,'rut_dv'=>'6','nombre1'=>'Paciente','appaterno'=>'Revisión','apmaterno'=>'Demo','nombre_completo'=>'Paciente Demo','estado'=>'activo','created_at'=>now(),'updated_at'=>now()]);
        ...
        $pacienteId=DB::connection('medichile')->table('pacientes')->updateOrInsert(['rut'=>'10211568-6'],['nombre'=>'Paciente Demo','email'=>'paciente@gmail.com','telefono'=>'+56900000000','created_at'=>now(),'updated_at'=>now()]);
